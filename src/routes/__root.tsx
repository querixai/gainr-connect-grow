...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Gainr is an AI-powered hyperlocal marketplace developed by EmpowerNet Technologies Private Limited. Discover local services, freelance opportunities, rental marketplace, business promotion, surveys, and customer verification solutions." },
      ...
      { property: "og:description", content: "AI-powered hyperlocal marketplace connecting people, businesses, freelancers and local services." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Gainr | AI-Powered Hyperlocal Marketplace" },
      { name: "twitter:description", content: "Discover local services, freelance opportunities, rentals, surveys and more." },
    ],
    links: [
